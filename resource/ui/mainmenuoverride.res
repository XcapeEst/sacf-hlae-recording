...
"Resource/UI/MainMenuOverride.res"
{
	...
	"ConsoleButton"
	{
		...
		"SubImage"
		{
			...
			"visible"					"1"
			"enabled"					"1"
			"image"						"replay/thumbnails/softicons/console"
			"scaleImage"				"1"
			"proportionaltoparent"		"1"
		}
		"pin_to_sibling"				"MinMode"
	...
	"RetryButton"
	{
		...
		"SubImage"
		{
			...
			"visible"					"1"
			"enabled"					"1"
			"image"						"replay/thumbnails/softicons/retry"
			"scaleImage"				"1"
			"proportionaltoparent"		"1"
		}
	...
	"TransparentViewmodelsButtonOn"
	{
		...
		"labeltext"						""
		"default"						"1"
		"command"						"engine exec enable_transparency.cfg"
		"proportionaltoparent"			"1"
		"fgcolor_override"				"245 245 245 60"
		"defaultfgcolor_override"		"245 245 245 60"
		"armedfgcolor_override"			"245 245 245 160"
		...
		"SubImage"
		{
			...
			"visible"					"1"
			"enabled"					"1"
			"image"						"replay/thumbnails/softicons/tr-on"
			"scaleImage"				"1"
			"proportionaltoparent"		"1"
		}
		"pin_to_sibling"				"RetryButton"
		"pin_corner_to_sibling"			"0"
		"pin_to_sibling_corner"			"1"
	}
	"TransparentViewmodelsButtonOff"
	{
		...
		"labeltext"						""
		"default"						"1"
		"command"						"engine exec disable_transparency.cfg"
		"proportionaltoparent"			"1"
		"fgcolor_override"				"245 245 245 60"
		"defaultfgcolor_override"		"245 245 245 60"
		"armedfgcolor_override"			"245 245 245 160"
		...
		"SubImage"
		{
			...
			"visible"					"1"
			"enabled"					"1"
			"image"						"replay/thumbnails/softicons/tr-off"
			"scaleImage"				"1"
			"proportionaltoparent"		"1"
		}
